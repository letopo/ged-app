...
const DemandeBesoin = ({ formData, setFormData, pdfContainerRef }) => {
    ...
    const grandTotal = formData.lines.reduce((acc, line) => acc + calculateTotal(line), 0);
    ...
    return (
        ...
        >
            ...
            <div className="border-t-2 border-b-2 border-gray-800 py-3 mb-8 text-center">
                <h2 className="text-2xl font-bold">DEMANDE DE BESOIN</h2>
            </div>
            ...
            <div className="mb-6 space-y-3 text-sm">
                <div className="flex">
                    ...
                    <input 
                        ...
                        className="border-b border-gray-400 flex-1 px-2"
                ...
                <div className="flex">
                    <span className="font-semibold w-48">Référence demande :</span>
                    <input 
                        type="text" 
            ...
            <div className="mb-6">
                ...
                <table className="w-full border-collapse border border-black text-sm">
                    <thead>
                        <tr className="bg-gray-100">
                            <th className="border border-black p-2 w-[45%]">Désignation</th>
                            <th className="border border-black p-2 w-[15%]">Quantité</th>
                            <th className="border border-black p-2 w-[20%]">Prix Unitaire (FCFA)</th>
                            <th className="border border-black p-2 w-[20%]">Montant Total (FCFA)</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr key={index}>
                                ...
                                <td className="border border-black">
                                    <input 
                                        ...
                                        className="w-full p-2 h-10 text-center"
                                    />
                                </td>
                                <td className="border border-black">
                                    <input 
                                        ...
                                        onChange={(e) => handleLineChange(index, 'prixUnitaire', e.target.value)} 
                                        className="w-full p-2 h-10 text-right"
                                    />
                                </td>
                                <td className="border border-black">
                                    <div className="flex items-center justify-between p-2 h-10">
                                        <span className="flex-1 text-right bg-gray-50">
                                            {calculateTotal(line).toLocaleString('fr-FR')}
                                        </span>
                                        <button 
                                            type="button" 
                                            onClick={() => removeLine(index)} 
                                            className="text-red-500 hover:text-red-700 ml-2 not-printable"
                                        >
                                            <Trash2 size={16} />
                                        </button>
                                    </div>
                ...
                <button 
                    type="button" 
                    onClick={addLine} 
                    className="mt-3 flex items-center gap-2 text-blue-600 hover:text-blue-800 text-sm not-printable"
                >
            ...
            <div className="mb-6">
                ...
                <textarea 
                    ...
                    className="w-full border border-gray-400 p-3 min-h-[100px] text-sm"
            ...
            <div className="mt-16 grid grid-cols-3 gap-8 text-center text-sm">
                ...
                <div>
                    <div className="h-20 mb-2"></div>
                    <div className="border-t-2 border-dotted border-gray-400 pt-2">
                        <p className="font-semibold">Validation GLB</p>
                    </div>
                </div>
            </div>
