...
const DocumentList = () => {
  ...
  // ✅ Emails autorisés pour la Pièce de Caisse
  ...
  // ✅ NOUVEAU : Emails autorisés pour le Planning Opératoire
  const authorizedEmailsForPlanningOperatoire = [
    'hsjm.secdir@gmail.com',
    'hsjm.survge@gmail.com',
    'aureleyankeu@gmail.com'
  ];
      ...
      <aside className="lg:col-span-1">
        <div className="bg-white dark:bg-dark-surface p-4 rounded-lg shadow-sm dark:shadow-none border border-gray-200 dark:border-dark-border sticky top-8">
            ...
            <ul className="space-y-2">
                ...
                <li>
                  <Link to="/create-from-template" state={{ templateName: "Certificat d'aptitude" }} 
                    className="block p-3 bg-gray-50 hover:bg-blue-50 dark:bg-dark-bg dark:text-dark-text dark:hover:bg-blue-900/50 rounded-lg transition">
                    🩺 Certificat d'aptitude
                  </Link>
                </li>
                <li>
                  <Link to="/create-from-template" state={{ templateName: "Bon de commande" }}
                    className="block p-3 bg-gray-50 hover:bg-blue-50 dark:bg-dark-bg dark:text-dark-text dark:hover:bg-blue-900/50 rounded-lg transition">
                    🛒 Bon de commande
                  </Link>
                </li>
                <li>
                  <Link to="/create-from-template" state={{ templateName: "Bon de commande interne" }}
                    className="block p-3 bg-gray-50 hover:bg-blue-50 dark:bg-dark-bg dark:text-dark-text dark:hover:bg-blue-900/50 rounded-lg transition">
                ...
                {user && authorizedEmailsForPlanningOperatoire.includes(user.email) && (
                  <li>
                    <Link to="/create-from-template" state={{ templateName: "Planning Opératoire" }} 
                      className="block p-3 bg-gradient-to-r from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 dark:bg-gradient-to-r dark:from-purple-900/20 dark:to-pink-900/20 dark:text-dark-text dark:hover:from-purple-900/30 dark:hover:to-pink-900/30 rounded-lg transition border-2 border-purple-200 dark:border-purple-700">
                      🏥 Planning Opératoire
                    </Link>
                  </li>
                )}
