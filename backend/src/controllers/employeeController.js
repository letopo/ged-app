...
// @desc    Récupérer TOUS les employés actifs (sans pagination) - pour les plannings
...
export const getAllEmployees = async (req, res, next) => {
  try {
    ...
    // ✅ Retourner directement le tableau (pas d'objet wrapper)
    res.json(employees);
  } catch (error) {
    console.error('Erreur récupération tous les employés:', error);
